      ...
      <header className="sticky top-0 z-10 border-b bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-[1400px] items-center gap-3 px-4 py-3 sm:px-6">
          ...
          <button className="flex items-center gap-2 font-semibold transition-opacity hover:opacity-70" onClick={() => go(null)}>
            {/* The mark from the favicon, in the primary colour: three rising
                bars, the shape a status page reduces to. */}
            <svg viewBox="0 0 16 16" className="size-4 text-primary" aria-hidden fill="currentColor">
